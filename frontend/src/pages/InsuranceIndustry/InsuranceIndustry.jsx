...
<section className="pay-sec-hero bg-secondary-gradient position-relative zindex-1 overflow-hidden">
    <img src="/assets/img/em-host-wave-left.svg" title="Payzo " alt="Payzo Technology" className="position-absolute start-0 bottom-0 zindex--1 soft-light opacity-50" />
       <img src="/assets/img/em-host-wave-right.svg" title="Payzo " alt="Payzo Technology" className="position-absolute end-0 bottom-0 zindex--1 soft-light opacity-50" />
         <div className="container">
                <div className="row align-items-center">
                    <div className="col-xxl-6 col-xl-7 col-lg-7">
                        <div className="pay-hero-content mt-50">
                            <h1 className=" mb-3 fw-bold">Efficient Payment Solutions in the Insurance Industry</h1>
                            <h3 className="mb-40 ">Payment gateways are a vital part of the operations of insurance firms, helping them to collect premiums, process claims, and conduct other financial transactions.
                                </h3>
  ...
  <div className="offset-1 col-xxl-4 col-xl-4 col-lg-4">
        <div className="email-hero-right mt-40 mt-lg-0">
            <img src="/assets/img/ins-img.png" title="Payment Processing" alt="Payment Processing" className="img-fluid animated2" />
        </div>
      </div>
     </div>
  </div>
...
<section id="edu_industry_sec" >
    <div className="container">
     <div className="title-head text-center">
      <span>Overview</span>
       <h2>Here's How payment gateways are used in the insurance industry</h2>
    </div>
        ...
        <div className="col-lg-3 col-md-6">
            <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                   <h3>Policy premium collection</h3>
        ...
        <div className="row pt-5 pb-5">
          ...
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
              ...
              <div className="content">
                ...
                <h3 className="text-light fw-bold lh-base">Payzo : Payment Gateway in the context of Insurance.</h3>
                 <ul className="p-0">
          ...
          <div className="col-lg-5 align-items-stretch order-1 order-lg-2 img aos-init aos-animate">
              <img src="/assets/img/ins_img.webp" title="Payment Gateway" alt="The Context of Insurance" style={{"width":"100%","borderRadius":"20px"}} />
          </div>
        </div>
