    ...
    <img src="/assets/img/em-host-wave-left.svg" alt="shape" className="position-absolute start-0 bottom-0 zindex--1 soft-light opacity-50" />
       <img src="/assets/img/em-host-wave-right.svg" alt="shape" className="position-absolute end-0 bottom-0 zindex--1 soft-light opacity-50" />
                ...
                <div className="row align-items-center">
                    <div className="col-xxl-6 col-xl-7 col-lg-7">
                        <div className="pay-hero-content mt-50">
                            <h1 className=" mb-3 fw-bold">Payment Gateway Solution in B2B Industry</h1>
                            <h3 className="mb-40 ">The B2B (business-to-business) industry relies heavily on payment gateways to facilitate secure and efficient financial transactions between businesses. 
                                </h3>
        ...
        <div className="email-hero-right mt-40 mt-lg-0">
            <img src="/assets/img/B2B-eCommerce.png" title="Payment Gateway Solution" alt="B2B Industry" className="img-fluid animated2" />
        </div>
      </div>
     </div>
  </div>
...
<section id="edu_industry_sec">
    <div className="container">
     <div className="title-head text-center">
      <span>Overview</span>
       <h2>Here's How Payment Gateways are relevant to the B2B Industry</h2>
    </div>
        ...
        <div className="col-lg-3 col-md-6">
            <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                  ...
                  <h6 className="card_pg_text pt-3">Businesses can instantly transmit and receive payments for bills, purchase orders, and invoices thanks to B2B Payment Invoicing & Supply Chain Finances.</h6>
                </div>
            </div>
        </div>
    ...
    <div className="col-lg-3 col-md-6">
      <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                 ...
                 <h6 className="card_pg_text pt-3">B2B Payment Invoicing & Supply Chain Finances make it easier for customers to pay for goods and services by enabling businesses to accept credit card payments from other businesses.
</h6>
                </div>
            </div>
        </div>
         ...
         <div className="col-lg-3 col-md-6">
           <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                  ...
                  <h6 className="card_pg_text pt-3">Electronic check (e-check) payments, which are frequently used for major business-to-business transactions, are supported by B2B Payment Invoicing & Supply Chain Finances.</h6>
                </div>
            </div>
        </div>
         <div className="col-lg-3 col-md-6">
        ...
        <div className="row pt-5 pb-5">
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
              <div className="content">
                ...
                <h3 className="text-light fw-bold lh-base text-capitalize">Payzo : Payment Gateway in the context of B2B industry</h3>
                 <ul className="p-0">
                  ...
                  <li><i className="ri-check-double-line"></i>Provide various payment options, including credit/debit cards, mobile wallets, supported by your chosen payment gate.
                  </li>
          ...
          <div className="col-lg-5 align-items-stretch order-1 order-lg-2 img aos-init aos-animate">
              <img src="/assets/img/b2b_img.jpg" alt="B2B Industry" title="Payment Gateway" className="img-fluid rounded" />
          </div>
        </div>
