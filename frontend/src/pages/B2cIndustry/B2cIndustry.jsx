...
export default function B2cIndustry() {
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: true
...
<section className="pay-sec-hero bg-secondary-gradient position-relative zindex-1 overflow-hidden">
                ...
                <div className="row align-items-center">
                    <div className="col-xxl-6 col-xl-7 col-lg-7">
                        <div className="pay-hero-content mt-50">
                            <h1 className=" mb-3 fw-bold">Payment Gateway Solution in B2C Commerce Industry</h1>
                            <h3 className="mb-40 ">The B2C Commerce (Business-to-Consumer) industry relies heavily on payment gateways to facilitate secure and efficient financial transactions between businesses. 
                                </h3>
  ...
  <div className="offset-1 col-xxl-4 col-xl-4 col-lg-4">
        <div className="email-hero-right mt-40 mt-lg-0">
            <img src="/assets/img/b2c-img.png" title="Payment Gateway Solution" alt="B2C Commerce Industry" className="img-fluid animated2" />
        </div>
      </div>
     </div>
  </div>
...
<section id="edu_industry_sec" >
    <div className="container">
     <div className="title-head text-center">
      <span>Overview</span>
       <h2>Here's How Payment Gateways are relevant to the B2C Commerce Industry</h2>
    </div>
        ...
        <div className="col-lg-3 col-md-6">
            <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                   <h3>Invoice and Bill Payments</h3>
    ...
    <div className="col-lg-3 col-md-6">
      <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                 ...
                 <h6 className="card_pg_text pt-3">B2B payment gateways make it easier for customers to pay for goods and services by enabling businesses to accept credit card payments from other businesses.
         ...
         <div className="col-lg-3 col-md-6">
           <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                   <h3>E-Check Processing</h3>
                  <h6 className="card_pg_text pt-3">Electronic check (e-check) payments, which are frequently used for major business-to-business transactions, are supported by B2B payment gateways.
   ...
   <div className="row mt-4 mb-5">
      ...
      <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                 ...
                 <h6 className="card_pg_text pt-3">Payment gateways frequently offer multi-currency functionality in the global B2B marketplace to handle foreign transactions and simplify currency exchange.
         ...
         <div className="col-lg-3 col-md-6">
           <div className="card edu_card_bx process-bx p-2 m-2">
                ...
                <div className="card-text">
                   <h3>Bulk Payments</h3>
                  <h6 className="card_pg_text pt-3">Certain NBFCs provide merchant services to companies so they can take end-consumer payments.
        ...
        <div className="row pt-5 pb-5">
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
              <div className="content">
                ...
                <h3 className="text-light fw-bold lh-base text-capitalize">Payzo : Payment Gateway in the context of B2C Commerce industry</h3>
                 <ul className="p-0">
                  ...
                  <li><i className="ri-check-double-line"></i>Provide various payment options, including credit/debit cards, mobile wallets,
                  supported by your chosen payment gateway.</li>
          ...
          <div className="col-lg-5 align-items-stretch order-1 order-lg-2 img aos-init aos-animate">
              <img src="https://www.swipez.in/blog/media/posts/23/2933578.jpg" title="Payment Gateway" alt="B2C Commerce Industry" style={{"width":"100%","borderRadius":"20px"}} />
          </div>
        </div>
