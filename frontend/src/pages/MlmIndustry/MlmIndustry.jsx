...
export default function MlmIndustry() {
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: true
...
<section className="pay-sec-hero bg-secondary-gradient position-relative zindex-1 overflow-hidden">
    ...
    <img src="/assets/img/em-host-wave-left.svg" title="Payzo Technology" alt="Payzo" className="position-absolute start-0 bottom-0 zindex--1 soft-light opacity-50" />
       <img src="/assets/img/em-host-wave-right.svg" title="Payzo Technology" alt="Payzo" className="position-absolute end-0 bottom-0 zindex--1 soft-light opacity-50" />
         <div className="container">
                <div className="row align-items-center">
                    <div className="col-xxl-6 col-xl-7 col-lg-7">
                        <div className="pay-hero-content mt-50">
                            <h1 className=" mb-3 fw-bold">Payment Gateway Solutions Managing Transactions for MLM & Direct Sales</h1>
                            <h3 className="mb-40 ">MLM & Direct Sales, which stands for Multi-Level Marketing, is a marketing and business model in which a company's products , often referred to as distributors or members.  
                                </h3>
  ...
  <div className="offset-1 col-xxl-4 col-xl-4 col-lg-4">
        <div className="email-hero-right mt-40 mt-lg-0">
            <img src="/assets/img/mlm-software.png" title="Payment Gateway Solutions" alt="Managing Transactions for MLM & Direct Sales" className="img-fluid animated2" />
        </div>
      </div>
     </div>
  </div>
...
<section id="edu_industry_sec" >
    <div className="container">
     <div className="title-head text-center">
      <span>Overview</span>
       <h2>How payment gateways are used in the MLM & Direct Sales (Multi level marketing) industry</h2>
    </div>
        ...
        <div className="row pt-5 pb-5">
          ...
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
              ...
              <div className="content">
                ...
                <h3 className="text-light fw-bold lh-base">Payzo : Payment Gateway in the context of MLM & Direct Sales(multi level marketing).</h3>
                 <ul className="p-0">
          ...
          <div className="col-lg-5 align-items-stretch order-1 order-lg-2 img aos-init aos-animate">
              <img src="/assets/img/MLM & Direct Sales-pg.jpg" title="multi-level marketing" alt="Managing Transactions for MLM & Direct Sales" className="img-fluid"  />
          </div>
        </div>
